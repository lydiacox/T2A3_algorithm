class Shopping_list():
    ...
    Methods
    -------
    get_list : A function to iterate through the list of books available for purchase
    ...
    def __init__(self):
        self.shopping_list = []
        self.books = ['The Coder\'s Algorithm', 'The Chamber of Stack Overflow', 'The Prisoner of Infinite Loops', 'The Goblet of Coffee', 'The Order of Control Flow']
...
class Print_Price():
    '''A class to print the price of the customer's purchase and any discount applied.
    ...
